...
'''
File    :   train_v02.py
Time    :   2020/11/12 15:14:16
Author  :   Chao Wang 
Version :   1.0
Contact :   374494067@qq.com
@Desc    :   train_v01 + feature_importance
'''
...
def display_importances(feature_importance_df_, doWorst=False, n_feat=50):
    ...
    plt.title('catb Features')
    plt.tight_layout()
    plt.savefig('polt/catb_importances.png')
...
### for feature importance
    ...
    for train, test in sk.split(train_data, label):
        ...
        no_important = display_importances(feature_importance_df_=importance_df, n_feat=200)

        No_important.append(no_important)

    r = list(set(No_important[0]).intersection(No_important[1],No_important[2],No_important[3],No_important[4]))

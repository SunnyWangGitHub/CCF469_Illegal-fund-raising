...
'''
File    :   train_v01.py
Time    :   2020/11/12 11:54:38
Author  :   Chao Wang 
Version :   1.0
Contact :   374494067@qq.com
@Desc    :   train_v01.py + 去掉（train_v2.py）选的无用特征
'''
...
def data_process():
    ...
    cat_features=['industryphy','opform','bucket_regcap',
                'bucket_reccap','bucket_regcap_reccap',
                'enttypegb','enttypeitem','enttypegb_enttypeitem',
                'industryphy','industryco','industryphy_industryco',
                'adbusign','townsign','regtype','TAX_CATEGORIES'
    ...
    # drop = ['ANNREDMEMNUM', 'forreccap', 'congro', 'midpreindcode', 'FARNUM', 'ANNNEWMEMNUM', 'ptbusscope', 'MEMNUM', 'oploc']
    # for f in drop:
    #     del all_data[f]
...
if __name__ == "__main__":
    ...
    #                             early_stopping_rounds=50
    #                           )  
    # # offline: 0.8397237716966625
    # # online :0.82695630339
    ...
    # offline: 0.8447561875793252
    # online :0.83068631733 
